...
const avis = new Avis("Superbe Voiture, Eleguante!", new Date(), user);
const avisTwo = new Avis("Joli bagnole :)", new Date(), user);
const avisThree = new Avis("Super Génial !!!", new Date(), user);
