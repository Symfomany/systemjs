...
$(function(){
    ...
    let description = $(`<p>${voiture.marque} - ${voiture.modele} 
                        ...
                        de couleur ${voiture.color} et immatriculé ${voiture.immatriculation}</p>`);

    $('div.content h2').text(voiture.marque);
    $('div.content .mdl-card__supporting-text').html(voiture.marque);
});