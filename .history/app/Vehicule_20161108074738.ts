...
import * as request from 'request';
    ...
    export class Vehicule implements MotorInterface {
        ...
        public getProprietaire(){
            let info = null;
            return request.get('https://randomuser.me/api/', function (error, response, body) {
            ...
            /*return request.get('https://randomuser.me/api/').on('response', function(response) {
                //console.log(response.toJSON()) // 200
                console.log(response.responseToJSON()) // 200
            });*/
