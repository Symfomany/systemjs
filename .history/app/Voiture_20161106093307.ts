import {Garage} from '../.history/app/Garage_20161105132250';
...
export class Voiture extends Vehicule {
  ...
  */
  constructor(params: any, paramsVehicule:any, vente:boolean, options:any) {
    ...
    this._options = [this.options, ...options]; //concaténation
    this._vente = vente;
  }
   ...
   */
  toString():string{
    return `La voiture est une ${this.marque} et elle est de ${Garage.PAYS}`;
  }
