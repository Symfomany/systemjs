...
import {without,uniq,take,filter,remove,indexOf,find} from 'lodash';
    ...
    export class Vehicule implements MotorInterface {
        ...
        public setAvis(oldContent:string, content:string = ""){
            ...
            return this._avis.splice(index, 1, {"Super Génial !!!", new Date()created: new Date(), content: content});
        }
