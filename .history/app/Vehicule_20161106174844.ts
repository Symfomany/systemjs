...
import * as _ from '../typings/lodash/lodash.d.ts';
    ...
    export class Vehicule implements MotorInterface {
         ...
         * @memberOf Vehicule
         */
        public setAvis(datas = {content: null, user: null}){

            console.log(_.without(this._avis, function(elt){
                return elt.content = "Joli bagnole :)";
            }));
