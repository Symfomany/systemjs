...
const avis = new Avis(user, "Superbe Voiture, Eleguante!", new Date());
const avisTwo = new Avis(user, "Joli bagnole :)", new Date());
const avisTwo = new Avis(user, "Super Génial !!!", new Date());
const options =  ['jantes alu', 'toit ouvrant'];


let bmw = new Voiture(datasVehicule,datasVoiture,true,options);
bmw.addAvis(avis,avisTwo);
